    ...
    <>
      <div className="w-full min-h-[90vh] flex flex-col items-center justify-center">
        <div className="title text-5xl max-sm:text-3xl text-center flex flex-col font-medium">
          <div>
            From <span className="font-black text-[#FF756A]">cluttered</span> to{" "}
          </div>
          <div>
            <span className="font-black text-[#FF756A]">Click-worthy</span> in
            seconds{" "}
          </div>
        </div>
        <div className="sub-content poppins text-lg max-sm:text-xs max-sm:px-5 font-medium flex flex-col items-center my-8 tracking-wide">
          <span>
            Transform bulky URLs into tiny power-links with just one click.
          </span>
          <span>Because every click deserves a cleaner, smarter link.</span>
        </div>
        <div className="w-full flex justify-center gap-10">
          <Link href={'/shorten'}>
            <button className="button poppins">Try Now</button>
          </Link>
          <Link href={'https://github.com/mishra0703'} target = '_blank'>
            <button className="git-button">
              ...
              <p className="text poppins">Follow</p>
            </button>
          </Link>
        </div>
      </div>
